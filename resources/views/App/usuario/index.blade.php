                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nombre</th><th>Nombre Completo</th><th>Password</th><th>Avatar</th><th>Usu Verificado</th><th>Tipo</th><th>Direccion</th><th>Localidad</th><th>Mail</th><th>Telefono</th>
                                        <th>
                                ...
                                @foreach($usuario as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombre }}</td><td>{{ $item->nombre_completo }}</td><td>{{ $item->password }}</td><td>{{ $item->avatar }}</td><td>{{ $item->usu_verificado }}</td><td>{{ $item->tipo }}</td><td>{{ $item->direccion }}</td><td>{{ $item->localidad }}</td><td>{{ $item->mail }}</td><td>{{ $item->telefono }}</td>
                                        <td>
                                            <div class="float-right" >
